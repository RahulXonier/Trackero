...
const Hero = () => {
    ...
    return (
        <div className='w-full min-h-[90vh] relative py-20'>
            ...
            <div className='max-w-7xl mx-auto h-full  flex flex-col lg:flex-row justify-between gap-12 lg:gap-0 lg:px-0 px-2'>
                <div className='w-full lg:w-[42%] flex flex-col gap-6'>
                    ...
                    <p className='text-[18px] text-[var(--ink-500)]'>Get 360<sup>o</sup>{' '} view of your business operations in one place.
                ...
                <div className='w-full lg:w-[53%] relative z-2 flex items-center'>
