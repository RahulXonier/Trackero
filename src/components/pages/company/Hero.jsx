        ...
        <>
            <section className="relative w-full min-h-[60vh]  overflow-hidden bg-gradient-to-b from-[#f1f6fb] to-[#eaf3f9] pt-20 pb-24 lg:pt-28 lg:pb-36 ">
                ...
                <div className="max-w-[1200px] mx-auto px-7  text-center relative z-10 flex flex-col items-center justify-center ">
                    ...
                    <h1 className="font-sora text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#15233b] tracking-tight max-w-4xl mx-auto leading-[1.15] mb-6">
                        We are here to unify how the <span className="bg-gradient-to-r from-[#16c2cf] to-[#0fb8a5] bg-clip-text text-transparent">world works together.</span>
                    </h1>
                    <p className="text-lg md:text-xl text-[#5a6b86] max-w-2xl mx-auto leading-relaxed">
